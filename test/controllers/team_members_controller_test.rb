...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post team_members_url, params: { team_member: { achievement: @team_member.achievement, department_id: @team_member.department_id, name: @team_member.name, position: @team_member.position } }
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { achievement: @team_member.achievement, department_id: @team_member.department_id, name: @team_member.name, position: @team_member.position } }
